            ...
            <div id="sidebar-menu" className="sidebar-menu">
              ...
              <ul>
                ...
                >
                  <Link to="/customer-details">
                    <FeatherIcon icon="file" /> <span>Customer Details</span>
                  </Link>
                </li>
                <li
                  className={`${
              ...
              <ul>
                ...
                >
                  ...
                  >
                    <FeatherIcon icon="file" /> <span> Invoices</span>
                    <span className="menu-arrow"></span>
                  </Link>
                  {isSideMenu == "invoice-list" ? (
                    ...
                    >
                      ...
                      <li>
                        <Link
                          to="/invoice-detail-admin"
                          className={`${
                            "/invoice-detail-admin" === pathName ? "active" : ""
                          }`}
                        >
                          Invoices Details (Admin)
                        </Link>
                        <Link
                          to="/invoice-detail-customer"
                          className={`${
                            "/invoice-detail-customer" === pathName
                              ? "active"
                              : ""
                          }`}
                        >
                          Invoices Details (Customer)
                        </Link>
                      </li>
                      <li>
                        <Link
              ...
              <ul>
                ...
                <li
                  className={`${
                    "/account-settings" === pathName ? "active" : ""
                  }`}
                >
